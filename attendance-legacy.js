import {readUntilReady,readJson} from './attendance-io.mjs';
...
async function getColors(cid){
  ...
  async function loadClass(cid,keepDate='',forceColors=false){
    ...
    try{
      const out=await getReader(currentClass);if(disposed||currentClass!==colorClass)return;parseReader(out);
