export async function mountTeacherWorkspace(parent,{db,user,classInfo,preview=false}){
 ...
 const labels={home:'우리 반 홈',timetable:'전체 시간표',attendance:'출결 통계',surveys:'만족도조사',materials:'강의자료',resources:'공지·바로가기'};
 ...
 for(const e of following){if(e===taskHead||e===tasks)panels.home.append(e);else panels.resources.append(e);}
 const today=document.createElement('section');panels.home.prepend(today);
