...
const BETA_STYLE=`.source-groups{display:grid;grid-template-columns:483px 1100px minmax(220px,1fr);min-width:1803px;position:sticky;top:0;z-index:3}.source-groups>div{padding:10px 12px;font-size:12px;font-weight:900;min-height:54px}.source-groups small{display:block;font-size:10px;font-weight:500;margin-top:3px}.sheet-group{background:#dceaff;color:#174477;border-top:4px solid #3e78c4}.checkhere-group{background:#d9f0ea;color:#17594f;border-top:4px solid #348977;border-left:3px solid #7cb4a8}.manual-group{background:#e9edf2;color:#445568;border-top:4px solid #7d8d9f;border-left:3px solid #a4afbc}.table-head{top:58px}.table-head>div:nth-child(-n+4){background:#edf4ff;color:#174477}.table-head>div:nth-child(n+5):nth-child(-n+9){background:#eaf7f3;color:#17594f}.table-head>div:last-child{background:#f0f3f7;color:#445568}.student-row>.cell:nth-child(-n+4){background:#f8fbff}.student-row>.cell:nth-child(n+5):nth-child(-n+9){background:#f4faf8}.student-row>.cell:last-child{background:#f8f9fb}.table-head>div:nth-child(5),.student-row>.cell:nth-child(5){border-left:3px solid #7cb4a8}.table-head>div:last-child,.student-row>.cell:last-child{border-left:3px solid #a4afbc}.raw-card .section-head{background:#edf4ff;border-top:4px solid #3e78c4}.raw-card .section-head h3{color:#174477}.manual-card .section-head{background:#f0f3f7;border-top:4px solid #7d8d9f}.student-row:hover>.cell{filter:brightness(.985)}.workspace{grid-template-columns:205px minmax(0,1fr)}.table-head,.student-row{grid-template-columns:80px 118px 145px 140px 220px 130px 290px 290px 170px minmax(220px,1fr);min-width:1803px}.beta-status,.beta-evidence,.beta-reason{width:100%;min-width:0;border:1px solid #cbd5e1;border-radius:8px;padding:8px 5px;background:#fff;font-size:11px}.beta-status:disabled,.beta-evidence:disabled{color:#64748b;background:#f8fafc}.beta-docs{flex-direction:column;justify-content:center;gap:6px}.docmemo{padding:5px 8px;font-size:10px}.beta-source{display:block;font-size:11px;line-height:1.6;white-space:pre-wrap;overflow-wrap:anywhere}.beta-source small{display:block;font-size:9px;color:#64748b}.reason{width:145px}.table-head .btn{font-size:10px;padding:5px;margin-top:5px}.autosave-notice{white-space:normal;font-size:11px}.raw-text{min-height:260px}.table-scroll{max-height:none;overflow-x:auto;overflow-y:visible;scrollbar-gutter:stable}.left-stack{align-content:start}.data-panel{min-height:1000px}.table-head{position:sticky;top:0;z-index:2}.rows{max-height:none;overflow:visible;min-width:1803px}.source-value{white-space:pre-wrap}.beta-source .docmemo{display:block;margin-top:7px}.memo-cell textarea{min-height:70px;overflow-wrap:anywhere}.legacy-memo{margin-top:12px;padding-top:10px;border-top:1px solid #e2e8f0}dialog{max-height:85vh;overflow:auto}dialog{max-width:560px;width:95%;border:1px solid #cbd5e1;border-radius:14px;padding:20px}dialog::backdrop{background:#0f172a66}dialog textarea{width:100%;min-height:140px;padding:10px;border:1px solid #cbd5e1;border-radius:8px}dialog .followup-btn{font-size:11px;padding:8px}dialog .btn{margin-top:14px}@media(max-width:1080px){.workspace{grid-template-columns:1fr}}`;

const SOURCE_STYLE=`.existing-record{padding:9px;background:#fff;border:1px solid #b6c8c2;border-left:4px solid #528676;border-radius:7px;min-height:66px}.existing-record>strong{display:block;font-size:10px;color:#356358;margin-bottom:5px}.proposal-box{border-left:4px solid #d59a2b!important;background:#fff8e9!important}.proposal-box>strong{display:block;margin-bottom:4px}.excursion-day{color:#8c4a00;background:#fff1cb;padding:9px 12px;border:1px solid #e9bc68;border-radius:8px;font-size:12px}.excursion-day[hidden]{display:none}.proposal-input{width:100%;min-height:85px;resize:vertical;font:inherit;border:1px solid #bccbd8;border-radius:6px;padding:6px}.proposal-times{display:flex;gap:5px;flex-wrap:wrap}.proposal-times input{width:100%;min-width:0;font-size:11px}.proposal-times label{width:100%;font-size:10px}.proposal-cell-actions{display:flex;gap:4px;flex-wrap:wrap}.proposal-dialog table{border-collapse:collapse;width:100%;font-size:12px}.proposal-dialog td,.proposal-dialog th{border:1px solid #dbe3ee;padding:8px;white-space:pre-wrap}.proposal-dialog pre{white-space:pre-wrap}.proposal-label{font-weight:700}.table-head{top:58px}.proposal-box{margin:9px 0;padding:9px;border:1px solid #cbd5e1;border-radius:8px;background:#f8fafc;white-space:normal}.proposal-box.changed{background:#fff7e6;border-color:#d59a2b}.proposal-box strong{color:#855300;font-size:11px}.proposal-preview{white-space:pre-wrap;overflow-wrap:anywhere;margin:5px 0}.proposal-box .btn{font-size:10px;padding:6px}.proposal-dialog{max-width:720px}.proposal-dialog p{font-size:13px;line-height:1.6}.proposal-dialog label{display:block;margin:12px 0;font-weight:700}.proposal-dialog select{display:block;padding:8px;width:100%}.proposal-dialog pre,.proposal-source{padding:12px;background:#eef6f5;white-space:pre-wrap;overflow-wrap:anywhere;font-family:inherit;font-size:13px}.proposal-actions{display:flex;gap:8px;flex-wrap:wrap}.proposal-dialog button{border:1px solid #cbd5e1;border-radius:8px;padding:8px;cursor:pointer}.proposal-dialog button:disabled{opacity:.5}.proposal-warning,#proposalState{color:#9a5200}.source-value:empty::before{content:'사유 없음';color:#64748b}.workspace{grid-template-columns:205px minmax(0,1fr)}@media(max-width:1080px){.workspace{grid-template-columns:1fr}}`;
...
const FIT_STYLE=`.wrap{--columns:minmax(54px,.55fr) minmax(92px,.92fr) minmax(100px,1fr) minmax(104px,1.04fr) minmax(146px,1.46fr) minmax(74px,.74fr) minmax(180px,1.8fr) minmax(180px,1.8fr) minmax(108px,1.08fr) minmax(138px,1.38fr);--table-min:1176px}.workspace{grid-template-columns:168px minmax(0,1fr);gap:9px}.table-head,.student-row,.source-groups{grid-template-columns:var(--columns);min-width:var(--table-min)}.rows{min-width:var(--table-min)}.source-groups>div:nth-child(1){grid-column:1/5}.source-groups>div:nth-child(2){grid-column:5/10}.source-groups>div:nth-child(3){grid-column:10/11}.source-groups>div{padding:9px 8px;font-size:11px}.table-head>div{padding:8px 5px;overflow-wrap:anywhere}.cell{padding:7px 5px;align-items:flex-start}.cell.name{align-items:center}.reason{width:auto}.beta-status,.beta-evidence{padding:8px 2px;font-size:11px}.existing-record,.proposal-box{padding:7px}.proposal-input{min-height:75px}.proposal-box .btn{padding:5px 4px}.proposal-times input{padding:2px;font-size:10px}.beta-source{font-size:11px}.data-title{padding:10px}.data-title span{display:none}.raw-text{padding:11px 9px}.manual-body{padding:10px 8px}.manual-issue-head{flex-wrap:wrap}.manual-issue-head strong{font-size:11px}.manual-issue textarea{padding:7px}.name{font-size:11px;overflow-wrap:anywhere}.source-value{overflow-wrap:anywhere}.memo-cell{min-width:0}.memo-cell textarea{min-width:0}.table-scroll{scrollbar-gutter:auto}@media(max-width:1550px){.workspace{grid-template-columns:1fr}.left-stack{grid-template-columns:1fr 1fr}.raw-text{min-height:110px;max-height:170px}.manual-issue textarea{min-height:65px;max-height:100px}.raw-card .section-head p,.manual-card .section-head p{display:none}.data-panel{margin-top:0}}@media(max-width:760px){.left-stack{grid-template-columns:1fr}.table-scroll{overflow-x:auto}.workspace{display:block}}`;
const COMPACT_STYLE=`
.student-row>.cell:nth-child(-n+4){align-items:center;justify-content:center}
.student-row>.cell:first-child{align-items:center;justify-content:flex-start}
.student-row>.cell.reason{align-items:center}
.student-row>.cell{padding-top:5px;padding-bottom:5px}
.student-row .beta-status,.student-row .beta-evidence,.student-row .beta-reason{padding-top:6px;padding-bottom:6px;min-height:30px}
.student-row .beta-source{line-height:1.35}
.student-row .existing-record{min-height:0;padding:5px 6px;line-height:1.3}
.student-row .existing-record>strong{margin-bottom:3px;font-size:9px}
.student-row .existing-record small{font-size:9px;line-height:1.2}
.student-row .proposal-box{margin:5px 0;padding:5px 6px;line-height:1.3}
.student-row .proposal-box>strong{display:inline;font-size:10px;margin:0 4px 0 0}
.student-row .proposal-label{display:inline;font-size:9px;font-weight:500}
.student-row .proposal-box>small:not(.proposal-label){line-height:1.25;margin-top:3px;font-size:9px}
.student-row .proposal-box>small:empty{display:none}
.student-row .proposal-input{display:block;height:46px;min-height:46px;padding:4px;margin-top:4px;line-height:1.35;font-size:11px}
.student-row .proposal-times{display:grid;gap:3px;margin-top:4px}
.student-row .proposal-times label{display:grid;grid-template-columns:24px minmax(0,1fr);align-items:center;gap:3px;font-size:9px}
.student-row .proposal-times input{height:24px;font-size:10px;padding:1px;max-width:100%;min-width:0}
.student-row .proposal-cell-actions{gap:3px;margin-top:4px}
.student-row .proposal-box .btn{font-size:9px;padding:4px;line-height:1.2;min-height:22px}
.student-row .beta-source .docmemo{margin-top:4px;padding:4px 5px;font-size:9px;line-height:1.3}
.student-row .memo-cell textarea{height:48px;min-height:48px;padding:5px}
.student-row .derived-basis{font-size:9px;line-height:1.3}
`;
...
async function getColors(cid){const bg=await getColorsOnce(cid);if(!Array.isArray(bg)||!bg.length)throw Error('색상 데이터가 비어 있습니다.');return bg;}
  ...
  function queueSummary(out=null,persist=false){
    ...
    summaryTimer=setTimeout(()=>{void syncAttendanceSummary(db,user,cid,source).catch(e=>{if(!disposed&&cid===currentClass)showErr(new Error('출결 변경은 완료됐지만 통계 갱신에 실패했습니다. 출결 통계에서 다시 동기화해 주세요. '+e.message));});},1500);
  }
  ...
  function renderRows(label){
    ...
    rows.innerHTML=students.map((s,i)=>{const key=keyFor(s),bundle=normalizeMemoBundle(memos[key]),controls=beta.controls(s);return`<div class="student-row"><div class="cell"><div class="name">${esc(s.name)}</div>${summaryStudents[key]?.dropout?'<small class="warning">중도포기 · 자동</small>':''}</div><div class="cell center" style="flex-direction:column;gap:5px">${controls.status}</div><div class="cell reason">${controls.reason}</div><div class="cell beta-docs">${controls.evidence}<button class="btn ghost docmemo" data-docmemo="${esc(key)}">${bundle.documents?'● 기타 특이사항 있음':'＋ 기타 특이사항'}</button></div>${beta.snapshotCells(s,category=>columnMemoButton(s,category))}<div class="cell memo-cell"><textarea class="memo" data-key="${esc(key)}" data-category="manual" data-state-key="${i}-manual" placeholder="수기출석 관련 메모">${esc(bundle.manual)}</textarea><span class="memo-state" data-state="${i}-manual">${bundle.manual?'저장됨':''}</span>${followupControls(key,'manual',bundle.followup?.manual)}</div></div>`}).join('')||'<div class="empty">교육생이 없습니다.</div>';
  ...
  function columnMemoButton(s,category){
    ...
    return `<button type="button" class="btn ghost docmemo" data-column-memo="${category}" data-memo-key="${esc(key)}" aria-label="${esc(s.name+' '+MEMO_LABELS[category])}">${exists?'● 기타 특이사항 있음':'＋ 기타 특이사항'}</button>`;
  }
  function openStudentMemo(key,category){
    ...
    const legacy=category==='checkhereTimes'&&(bundle.checkhere||followupHasAny(bundle.followup.checkhere));
    dialog.innerHTML=`<h3>${esc(s?.name||'')} · ${esc(MEMO_LABELS[category])}</h3><p>포털 기타 특이사항입니다. 체크히어에 전송되지 않습니다.</p><textarea id="docMemoText" aria-label="${esc(MEMO_LABELS[category])}">${esc(bundle[category])}</textarea><span id="docMemoState" class="memo-state"></span>${followupControls(key,category,bundle.followup[category])}${legacy?'<div class="legacy-memo"><button id="legacyMemo" class="btn soft">기존 통합 체크히어 메모 보기</button></div>':''}<button id="docMemoClose" class="btn dark">닫기</button>`;
  ...
  async function exportCurrentExcel(){
    ...
    try{
      ...
      const aoa=[
        ...
        [],
        ['이름','출석현황','사유','서류제출','체크히어 관련 메모','체크히어-담임 알림','체크히어-이행 확인','서류제출 관련 메모','서류제출-담임 알림','서류제출-이행 확인','수기출석 관련 메모','수기출석-담임 알림','수기출석-이행 확인','체크히어 입실','체크히어 퇴실','체크히어 입실 메모','체크히어 퇴실 메모','체크히어 외출 구간','체크히어 수집 시각','체크히어 추천시간','입퇴실 요청 상태','입실·교시 추천사유','입실·교시 요청 상태','퇴실 추천사유','퇴실 요청 상태',...CHECKHERE_MEMO_CATEGORIES.flatMap(c=>[MEMO_LABELS[c],MEMO_LABELS[c]+'-담임 알림',MEMO_LABELS[c]+'-이행 확인'])]
      ];
  ...
  async function loadSelectedDate(){stopSnapshots();clearTimeout(snapshotTimer);pendingSnapshots=null;epoch++;const dateEpoch=++viewEpoch;lastLiveSignature='';showErr('');const label=dateSel.value,d=dates.find(x=>x.label===label);if(!d)return;currentIso=d.iso;try{sessionStorage.setItem("hintWorkContext",JSON.stringify({classId:currentClass,date:currentIso}));}catch{}topState.textContent=`${currentClass}반 · ${label} 불러오는 중…`;await Promise.all([loadMemos(currentClass,currentIso),beta.load(currentClass,currentIso)]);if(disposed||dateEpoch!==viewEpoch||!host.isConnected)return false;queueSummary();renderRawReason(label);renderRows(label);topState.textContent=`${currentClass}반 · ${label} · ${students.length}명`;const cid=currentClass,iso=currentIso;stopSnapshots=watchCheckHereDay(db,cid,iso,records=>{if(disposed||dateEpoch!==viewEpoch)return;pendingSnapshots={records,cid,iso};flushSnapshots();},e=>{if(!disposed&&dateEpoch===viewEpoch)$('#liveSheetState').textContent='체크히어 실시간 확인 실패 · 기존 표 유지 · '+e.message;});return true;}
  async function loadClass(cid,keepDate='',forceColors=false){
    epoch++;viewEpoch++;liveFailures=0;lastLiveSignature='';loadAbort?.abort();liveAbort?.abort();const controller=new AbortController();loadAbort=controller;
  ...
  let initial=ctx.initialContext||{};if(!ctx.initialContext)try{initial=JSON.parse(sessionStorage.getItem('hintWorkContext')||'{}');}catch{}
  ...
  async function refreshLive(){
    ...
    if(reading)return;
    if(!ready()){liveState.textContent='시트 자동 확인 대기 · 입력·저장 완료 후 재개';liveTimer=setTimeout(refreshLive,300000);return;}
    ...
    try{
      const out=await getReader(cid,true,liveAbort.signal);
      if(version!==epoch||cid!==currentClass||iso!==currentIso||!ready())return;
      const signature=JSON.stringify({attendance:out.attendance,reasons:out.reasons,backgrounds:out.attendanceBackgrounds||out.backgrounds});
      if(signature!==lastLiveSignature){
        const headers=(out.attendance?.[0]||[]).slice(4);if(!headers.some(d=>dateIso(d)===iso))throw Error('선택 날짜가 시트에서 바뀌었습니다. 다시 읽기로 확인해 주세요.');
        syncVisibleMemos();const previousColors=attendanceBackgrounds;parseReader(out);if(!attendanceBackgrounds.length)attendanceBackgrounds=previousColors;
        ...
        queueSummary(out);renderRawReason(dateSel.value);renderRows(dateSel.value);lastLiveSignature=signature;
      }
      liveFailures=0;liveState.textContent='시트 자동 확인 '+new Intl.DateTimeFormat('ko-KR',{timeZone:'Asia/Seoul',hour:'2-digit',minute:'2-digit',second:'2-digit',hour12:false}).format(new Date())+' · 5분 간격 · 메모·세부 구분은 다시 읽기로 갱신';
    }catch(e){if(e.name!=='AbortError'){if(e.retryable===false)liveFailures=Infinity;else liveFailures++;if(!disposed&&cid===currentClass)liveState.textContent='기존 표 유지 · 시트 자동 확인 실패 · '+e.message;}}
    finally{reading=false;if(!disposed&&host.isConnected&&Number.isFinite(liveFailures))liveTimer=setTimeout(refreshLive,Math.min(900000,300000*2**liveFailures));}
  }
  function flushSnapshots(){
    clearTimeout(snapshotTimer);
    if(!pendingSnapshots||disposed||!host.isConnected)return;
    const {records,cid,iso}=pendingSnapshots;
    if(cid!==currentClass||iso!==currentIso){pendingSnapshots=null;return;}
    if(document.hidden)return;
    if(reading||!ready()){liveState.textContent='체크히어 새 저장본 확인 · 입력·저장 완료 후 반영';snapshotTimer=setTimeout(flushSnapshots,1000);return;}
    pendingSnapshots=null;
    if(JSON.stringify(records)===JSON.stringify(beta.snapshotRows()))return;
    syncVisibleMemos();beta.replaceSnapshots(records);renderRows(dateSel.value);queueSummary();
    liveState.textContent='체크히어 DB 저장본 반영 완료 · 시트 자동 확인 5분 간격';
  }
  const onVisible=()=>{if(!document.hidden){flushSnapshots();}};
  window.addEventListener('focus',onVisible);document.addEventListener('visibilitychange',onVisible);liveTimer=setTimeout(refreshLive,300000);
  return {canLeave:()=>memosReady()&&beta.canNavigate(),dispose(){disposed=true;epoch++;viewEpoch++;stopSnapshots();clearTimeout(snapshotTimer);pendingSnapshots=null;viewAbort.abort();loadAbort?.abort();liveAbort?.abort();clearTimeout(liveTimer);window.removeEventListener('focus',onVisible);document.removeEventListener('visibilitychange',onVisible);root.removeEventListener('input',edited);root.removeEventListener('change',edited);}};
}
