...
export async function readExportAttendance(db,classId,from,to,signal,{classificationOnly=false}={}){
 ...
 if(!classificationOnly){await read(settings('attendanceOverviewMemo'),'메모·후속조치');
